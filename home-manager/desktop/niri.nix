...
# === Niri ===
{
  programs.niri = {
    ...
    settings = {
      ...
      # ---- Outputs ----
      # niri will auto-detect; uncomment + fill in to pin settings
      # outputs."eDP-1" = {
      #   scale = 1.0;
      ...
      layout = {
        ...
        focus-ring = {
          enable = true;
          width = 2;
          active.color = "#f38ba8"; # Tokyo Night red
      ...
      binds = with config.lib.niri.actions; {
        ...
        "Mod+Shift+D".action = spawn "wofi" "--show" "drun";
